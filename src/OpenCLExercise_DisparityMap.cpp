...
cl::Program program = OpenCL::loadProgramSource(context, "src/OpenCLExercise_DisparityMap.cl");
...
Core::readImagePGM("scene1.pgm", inputImage0Data, inputWidth0, inputHeight0);
Core::readImagePGM("scene2.pgm", inputImage1Data, inputWidth1, inputHeight1);
